...
public class JwtTokenUtil {
     ...
     * @return 生成的JWT
     */
    public static String createJWT(String userId, String username, Integer roleId, Audience audience) {
        try {
            // 使用HS256加密算法
     ...
     * @return 用户角色的值
     */
    public static Integer getRoleId(String token, String base64Security) {
        return parseJWT(token, base64Security).get("roleId", Integer.class);
    }
